<template>
  ...
  >
    ...
    <div class="my-4 dark:text-dark-tertiary-500" :class="meetings?.participants.length === 0 ? 'hidden' : ''">
...
import {type AttendeeJoinResponse, type MeetingResponse, MeetingService,} from "@/kernel";
